    ...
    <>
      {!showCards ? (
        <div className="min-h-screen bg-[url('./src/assets/loader.jpg')] bg-cover bg-center p-5 flex flex-col justify-between">
          ...
          >
            <h1 className="text-white text-4xl font-bold font-mono text-center">
              Marvel Memory Game
            </h1>
            <input
              type="text"
              ...
              required
            />
            <button type="submit" className="p-2 bg-blue-50/40 tracking-normal hover:tracking-widest hover:font-bold rounded-2xl w-30 transition-all ">
              Start
            </button>
          </form>
          <Footer />
